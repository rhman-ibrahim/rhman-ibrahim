...
<p>I have a dream of online transforming all of the small and medium businesses in my beloved city Alexandria (Egypt) using web applications, and to achieve so I'm starting to build Django project templates packed with applications such as login system, chat applications, blog system and a ticket tracker.</p>
